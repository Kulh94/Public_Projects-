...
$sql = "select * from Produkt where Kategorie='Drucker' order by P_NR";
...
echo"<tr class='zeile'><th>PRODUKT NR</th><th>MARKE</th><th>MODELL</th><th>PREIS</th><th>AUSWAHL</th></tr>";
