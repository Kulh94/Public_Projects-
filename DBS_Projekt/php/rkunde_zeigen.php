...
$sql = "select * from Rechnung where bestellung_nr='$rd_id'";
...
<td> <a href='r_update_formular.php?knr=$datensatz->R_NR&tt=$datensatz->DATUM&vn=$datensatz->PREIS_NETTO&nn=$datensatz->GESAMTPREIS' target='rechts'><button class='button' style='vertical-align:middle'><span>Update</span></button></a></td>
</tr>";
}
