...
<h3 align="center">KUNDE</h3>

<?php

$rd_id=($_GET['rknr']);

$sql = "select k.k_nr, k.titel, k.vorname, k.nachname, k.geburtsdatum, k.strasse, k.ort, k.plz, k.land, b.b_nr, b.datum  from Kunde k join Bestellung b on k.k_nr=b.kunden_nr join Rechnung r on r.bestellung_nr=b.b_nr where r.bestellung_nr='$rd_id'";
...
echo"<tr><th>KUNDEN NR</th><th>TITEL</th><th>VORNAME</th><th>NACHNAME</th><th>GEBURTSDATUM</th><th>STRASSE</th><th>ORT</th><th>PLZ</th><th>LAND</th><th>BESTELLUNG NR</th><th>BESTELL DATUM</th><th>AUSWAHL</th></tr>";
