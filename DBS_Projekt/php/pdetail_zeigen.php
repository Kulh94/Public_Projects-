...
<h3 align="center">LAGERORT DES PRODUKTES</h3>
...
$sql = "select produkt.p_nr, produkt.lager_nr, produkt.kategorie, produkt.marke, produkt.modell, produkt.preis_brutto, produkt.preis_netto, lager.l_nr , lager.strasse, lager.plz, lager.ort from produkt inner join lager on produkt.lager_nr = lager.l_nr where produkt.p_nr='$pd_id'";
...
echo"<tr><th>PRODUKT NR</th><th>MARKE</th><th>MODELL</th><th>LAGER NR</th><th>STRASSE</th><th>PLZ</th><th>ORT</th><th>AUSWAHL</th></tr>";
...
<td><a href='lager_zeigen.php?lnr=$datensatz->L_NR' target='rechts'><button class='button' style='vertical-align:middle'><span>$datensatz->L_NR</span></button></a> </td>
