...
$sql = "select * from Produkt order by P_NR";
...
echo"<tr> <th colspan='7'><a href='p_neu_formular.php' target='rechts'><button class='button2' style='vertical-align:middle'><span>NEUE PRODUKTE ANLEGEN</span></button></a></th></tr>";

echo"<tr><th>PRODUKT NR</th><th>KATEGORIE</th><th>MARKE</th><th>MODELL</th><th>PREIS NETTO</th><th>PREIS BRUTTO</th><th>AUSWAHL</th></tr>";
